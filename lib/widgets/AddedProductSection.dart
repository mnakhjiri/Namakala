...
class AddedProductSection extends StatefulWidget {
  AddedProductSection();
  ...
  @override
  State<AddedProductSection> createState() => _AddedProductSectionState();
}

class _AddedProductSectionState extends State<AddedProductSection> {
  @override
  Widget build(BuildContext context) {

    return Visibility(
      visible: !widget.editHidden,
      child: Column(
        children: [
          Directionality(
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  children: [
                    Image.network(widget.img_src ,  width: MediaQuery.of(context).size.width/5),
                    // Image.asset(img_src,
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 40 , child: ElevatedButton(onPressed: (){
                                  setState((){
                                    send("deleteProduct-" + widget.data, CurrentUser.port);
                                    widget.editHidden = true;
                                  });
                                },
                                    style: ButtonStyle(
